...
export const CarouselSlide: React.FC<CarouselSlideProps> = ({ image, style, className = '', label }) => {
  ...
  <>
    <div
      ...
      style={{
        width: 'min(68vw, 920px)', // responsive sizing (tweak as needed)
        maxWidth: '920px',
        aspectRatio: '16/8.5', // wide hero ratio
        borderRadius: '38px',
        overflow: 'hidden',
    ...
    >
      <Image
        ...
        alt={image.alt}
        fill
        sizes="(max-width: 768px) 92vw, (max-width: 1280px) 68vw, 920px"
