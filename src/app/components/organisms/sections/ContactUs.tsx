...
export const ContactUs: React.FC = () => {
  return (
    <>
      <section id="contact-us" className="w-full my-3 md:my-6">
        <div className="w-full mx-auto px-4 sm:px-6 lg:px-0">
          <h2 className="text-4xl sm:text-5xl font-extrabold text-[var(--color-primary-dark)] mb-12 text-center lg:text-right">
          ...
          <div className="w-full mx-auto rounded-2xl overflow-hidden shadow-2xl bg-gradient-to-t from-[#0F4A89] to-[#18528E]">
            <div className="grid grid-cols-1 md:grid-cols-6 lg:grid-cols-12 gap-6">
              ...
              */}
              <div
                className="block md:col-span-4 bg-white/5 p-6 lg:p-16 sm:block md:hidden lg:flex"
                aria-hidden="false"
              >
                <ContactInfo />
              </div>
              {/* Right - ContactForm (always present; full width on mobile) */}
              <div className="hidden md:block col-span-1 md:col-span-8 p-6 md:p-10 w-full">
                <ContactForm />
              </div>
            </div>
          </div>
